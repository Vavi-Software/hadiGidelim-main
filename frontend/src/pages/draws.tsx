...
const businesses = [
  {
    id: 1,
    name: "İşletme A",
    images: ["/VAVI2.png", "/VaviLacivert.png", "/icon-logo.png"],
  ...
  },
  {
    id: 4,
    name: "İşletme D",
    images: ["/VAVI2.png", "/ankara.png", "/icon-logo.png"],
                ...
                <Stack spacing={1} mt={2}>
                  ...
                  >
                    <Instagram
                      ...
                      onClick={() =>
                        window.open(
                          "https://www.instagram.com/vavi.software/",
                          "_blank"
                        )
                      }
                    />
                    <Instagram
                      ...
                      onClick={() =>
                        window.open(
                          "https://www.instagram.com/hadigidelim1.0/",
                          "_blank"
                        )
                      }
                    />
